// https://learnku.com/articles/42514
package main
...
import (
	...
	"github.com/wedojava/gowebstudy/lesson13/handler"
	"github.com/wedojava/gowebstudy/lesson13/middleware"
...
func main() {
	errWriter := vlog.ErrorLog.Writer()
